...
@section('content')
    <form class="layui-form" style="width: 80%;">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="jump" value="" placeholder="若填写则代表页面跳转到别的页面，链接以http://或https://开头，或者输入路由，路由参数用|隔开（例 admin@index|id=1|type=update）" autocomplete="false" class="layui-input">
            </div>
        </div>
