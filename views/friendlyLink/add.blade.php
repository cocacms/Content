...
@section('content')
    <form class="layui-form" style="width: 80%;">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="link" value="" lay-verify="required" placeholder="请输入链接/路由 路由参数用|隔开 例 admin@index|id=1|type=update" autocomplete="false" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            <div class="layui-input-block">
                <button class="layui-btn" lay-submit="" lay-filter="submit" data-url="{{route('friendlyLink@postAdd')}}">立即提交</button>
